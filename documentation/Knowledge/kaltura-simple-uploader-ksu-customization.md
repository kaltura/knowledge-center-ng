...
The configuration file for the KSU is an XML file with the following format:{% highlight xml %}<KUploadConfiguration> <fileFilters> <fileFilter/> </fileFilters> <limits/> </KUploadConfiguration> {% endhighlight %}
