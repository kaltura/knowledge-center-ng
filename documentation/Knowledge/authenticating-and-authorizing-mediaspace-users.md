...
<ol style="list-style-type: lower-alpha;">
  ...
  <li>
    Under <em>refreshRoleOnLogin</em>, select <strong>No</strong>.<br />This option is displayed only when using an external role authorization provider.<br /><img src="../../assets/650.img">
  </li>
</ol>
...
<img src="../../assets/651.img">

<img src="../../assets/652.img">
...
4.  Under *refreshDetailsOnLogin*, select your preference.  
    ...
    <img src="../../assets/656.img">
5.  Under *ldapServer*:
<ol style="list-style-type: lower-alpha;">
  <li>
    Select the LDAP Server access and bind settings.<br />Your <strong>bindMethod</strong> selection will affect the information you need to provide for authenticating the user.<br /><img src="../../assets/659.img">
  </li>
  <li>
...
*   A *sessionKey* URL parameter is automatically appended to the logout URL. This parameter securely encapsulates the user information, enabling you to know which user logged out. The *sessionKey* parameter is constructed using the [secret][14] shared with the login page.<img src="../../assets/668.img">
