...
3.  Click Search.<img src="../../assets/765.img">
...
3.  Select Manage from the Actions dropdown menu.  
    ...
    The specific publisher’s Kaltura Management Console (KMC) information is displayed in a separate window. <img src="../../assets/766.img">
...
3.  Select KMC Users from the Actions dropdown menu.<img src="../../assets/767.img">
...
3.  From the “actions” drop-down menu, select “MA Login”.<img src="../../assets/768.img">
...
<img src="../../assets/800.img">

#### <a name="pwd_security"></a>Publisher Specific Configuration – Password Security

Use this section to define the number of password attempts and the password replacement/retention policy.<img src="../../assets/801.img">

#### <a name="services_pkgs"></a>Publisher Specific Configuration – Service Packages

Use this section to set different service classes, editable through local XML files. This feature displays different service level indications in reports such as Publisher Usage and Publisher Management.<img src="../../assets/802.img">

#### <a name="new_acct"></a>Publisher Specific Configuration – New Account Options

Use this section to enable and control new publishers, and allow, for example, a free trial for a limited duration (assuming your free trial model is limited usage based).<img src="../../assets/803.img">
...
<img src="../../assets/804.img">

#### <a name="live_stream_cfg"></a>Publisher Specific Configuration – Live Stream Config

Use this section to configure the source of live streams. Currently, the Kaltura platform comes with Akamai built-in; other live stream sources are possible with an integration effort).<img src="../../assets/805.img">
...
<p class="BodyTextKWN">
  This section covers the profiles and objects that can be defined per-publisher, by using the publisher’s “Profiles” drop-down menu:<img src="../../assets/807.img">
</p>
...
2.  Check Remote Storage in the Enable/Disable Features section and click the config link or alternatively<ol style="list-style-type: lower-alpha;">
      ...
      <li>
        Select Remote Storage from the Profiles dropdown menu.<br />The specific Publisher’s Remote Storage Profile is displayed.<img src="../../assets/808.img">
      </li>
    </ol>
...
2.  Click Create New.<img src="../../assets/809.img">
...
1.  Go to the Publishers tab and select Publisher Management.
2.  Select the publisher account that you want to configure.
3.  Select Virus Scan from the Profiles drop down menu.<img src="../../assets/810.img">
...
You can configure scanning one or several data, media or document files.<img src="../../assets/811.img">
...
8.  To add a thumbnail, click the "Add Thumbnail" button and fill in the thumbnail values.<img src="../../assets/813.img">
...
3.  Select “Event Notifications” from the Profiles drop down menu.  
    ...
    The Event Notification screen is displayed.<img src="../../assets/821.img">
...
The publisher’s content will not be displayed; however, the publisher will still be able to login to the Kaltura Management Console.<img src="../../assets/826.img">
...
1.  Go to the Publishers tab and select Add New Publisher.<img src="../../assets/828.img">
...
4.  In the Publisher Specific Configuration page, enable the Content Distribution Model and click config.  
    ...
    The Distribution Profile page is displayed.<img src="../../assets/833.img">
...
6.  Select the provider type and click Create New.<img src="../../assets/774.img">
      
    The Profile Setup Configuration window opens.<img src="../../assets/775.img">
7.  Configure the values and scroll down for more options.<img src="../../assets/834.img">
8.  To set the status for a Submit, Update, Delete or Report action, select the "Enabled" value.
9.  To add a thumbnail, click "Add Thumbnail" and fill in the thumbnail values.<img src="../../assets/777.img">
10. To configure an existing distribution profile, choose the profile from the list and select the "Configure" action.<img src="../../assets/778.img">
...
<div class="WordSection1">
  ...
  <ol>
    ...
    <li>
      Click Create. The new user will receive an email with credentials for the Kaltura Admin Console.<img src="../../assets/837.img">
    </li>
  </ol>
  ...
  <ol>
    ...
    <li>
      Select a user and then select Change role from the Action drop down menu.<br /><br />The Change Role window is displayed.<img src="../../assets/838.img">
    </li>
    <li>
      Select a Role from the drop down menu and click Save.<img src="../../assets/839.img">
    </li>
  </ol>
  ...
  <ol>
    ...
    <li>
      Select Assign partners from the Action drop down menu.<img src="../../assets/840.img">
    </li>
    <li>
    ...
    <li>
      Click Save.<img src="../../assets/841.img">
    </li>
  </ol>
  ...
  <p>
    You should assign a role to each user to permit access to Admin Console functionality based on their organizational responsibilities.<img src="../../assets/843.img">
  </p>
  ...
  <ol>
    ...
    <li>
      Click on a Name and then select Configure from the Action drop down menu.<br /><br />The User Role Configuration window is displayed.<img src="../../assets/844.img">
    </li>
    <li>
...
2.  Select a Filter and then click Search.<img src="../../assets/845.img">
...
The In-Progress Tasks page refreshes every 30 seconds. You may pause and resume the automatic refresh, or refresh the page manually by clicking Refresh Now.<img src="../../assets/848.img">
...
You can start/stop, enable/disable or set the start-up type of each batch service.<img src="../../assets/851.img">
...
You can also access this page by clicking any Entry Name in the [In-Progress Tasks Page.  ][48] Click the Entry Name to display the Advanced Entry Investigation page. Click on the Account link to access the publisher KMC account.<img src="../../assets/850.img">
...
*   Go to the Developer tab and select API Documentation. For more information, see [here][50].<img src="../../assets/852.img">
...
*   Click “Clear opcode cache” at the top right corner.<img src="../../assets/853.img">
...
*   Go to the Developer tab and select API Client Libraries. For more information, see [here][51].<img src="../../assets/855.img">
...
<p dir="LTR">
  Use the System Helper tools in this section to debug Kaltura Sessions (KS), test the IP to Country and other encoding/decoding functions.<img src="../../assets/856.img">
</p>
